                          ...
                          [SWS_CANIF_00168]).*/
                            ...
                            else
                            {
                                ...
                                case CAN_TP:
                                {
                                    ...
                                    CanTp_RxIndication( UpperLayerUser_CanIf_LookUpTable_Rx[PduIndex], &CanTpRxPdu );
#endif
                                    break;
                                }
                                case PDUR:
...
#endif
#if 0
                                    PduR_CanIfRxIndication(UpperLayerUser_CanIf_LookUpTable_Rx[PduIndex],&pduInfo);
#endif
                                    break;
                                }
                                case CDD:
    ...
    if( CanIf_Global.initRun == (uint8_t)TRUE )
    {
        if( IS_VALID_TX_PDU_ID(CanTxPduId) == (uint8_t)TRUE )
        {
            ...
            case CAN_TP:
                ...
                CanTp_TxConfirmation(UpperLayerUser_CanIf_LookUpTable_Tx[CanTxPduId], E_OK);
#endif
                break;
            case PDUR:
#if 0
                PDUr_TxConfirmation(UpperLayerUser_CanIf_LookUpTable_Tx[CanTxPduId], E_OK);
#endif
                break;
            default:
                break;
