...
LOCAL FUNC(void,CANTP) ComputeBlockSize( FUNC_P2CONST(CanTpRxNSdu_s, CANTP, AUTOMATIC) rxConfig,
                                         FUNC_P2VAR(RunTimeInfo_s, CANTP, AUTOMATIC) rxRuntimeParam ,
										 FUNC_P2VAR(uint8 , CANTP, AUTOMATIC) BS );

LOCAL FUNC(void,CANTP) MainFunctionTransmitChannel( FUNC_P2CONST(CanTpTxNSdu_s, CANTP, AUTOMATIC) txConfig,
                                                    FUNC_P2VAR(RunTimeInfo_s, CANTP, AUTOMATIC) txRuntime ,
													FUNC_P2CONST(CanTpRxNSdu_s, CANTP, AUTOMATIC) rxConfig);

LOCAL FUNC(void,CANTP) MainFunctionReceiveChannel( FUNC_P2CONST(CanTpRxNSdu_s, CANTP, AUTOMATIC) rxConfig,
		                                           FUNC_P2VAR(RunTimeInfo_s, CANTP, AUTOMATIC) rxRuntime);
...
LOCAL FUNC(BufReq_ReturnType,CANTP) SendNextTxFrame( FUNC_P2CONST(CanTpTxNSdu_s, CANTP, AUTOMATIC) txConfig,
                                                    FUNC_P2VAR(RunTimeInfo_s, CANTP, AUTOMATIC) txRuntime );
