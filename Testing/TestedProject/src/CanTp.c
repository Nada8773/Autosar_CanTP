 ...
 *                                                                                          *
 * contacts:   : Hesham El Sherbieny (h.elsherbieny@gmail.com)                              *
 *                                                                                          *
    ...
    else
    {
        if (CanTpRunTimeTxData[TxPduId].state == IDLE)
        {
            ...
            case  FIRST_FRAME :
                ...
                trace_printf("If Bufer Data %d  %d ",CanTpRunTimeTxData[TxPduId].IfBuffer.IFdataPtr[0],CanTpRunTimeTxData[TxPduId].IfBuffer.IFdataPtr[1]);
#endif
...
uint8 i;
       ...
       {
           trace_printf("tx Data %d =",pduInfo.SduDataPtr[i]);
       }
...
#if DUBGE == TRUE
    trace_printf("FC send CanTp to Canif id = %d", FC_Id );
#endif
